...
//        switch self {
//        case .back:
//            return Icon.arrowLeft.unicode.typographyIcon(color, font: Font.Icon._22)
//        case .dismiss:
//            return Icon.App.chevronDown.unicode.typographyIcon(color, font: Font.Icon._22)
//        case .next:
...
//            return Icon.App.gear.unicode.typographyIcon(color, font: Font.Icon._20)
//        case .challenge:
//            return Icon.App.gear.unicode.typographyIcon(color, font: Font.Icon._20)
//        case .setting:
//            return Icon.App.gear.unicode.typographyIcon(color, font: Font.Icon._22)
//        case .invite:
//            return "invite".typography(.textStrong, color: color)
//        case .send:
//            return "Send".typography(.textStrong, color: color)
//        case .notifications:
//            return Icon.App.gear.unicode.typographyIcon(color, font: Font.Icon._24)
//        case .messages:
//            return Icon.App.gear.unicode.typographyIcon(color, font: Font.Icon._24)
//        default:
...
//    }
//
//    func updateNavigationBar(_ titleStyle: NavTitleStyle = .empty, titleColor: UIColor = Color.white, leftButton: NavBarButtonStyle = .none, leftColor: UIColor = Color.white, rightButton: NavBarButtonStyle = .none, rightColor: UIColor = Color.white, isBarHidden: Bool = false) {
